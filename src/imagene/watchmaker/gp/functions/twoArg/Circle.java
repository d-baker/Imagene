...
public class Circle extends BinaryNode
{
    public Circle(Node left, Node right)
    {
        super(left, right, "circle");
    }

    public double evaluate(double[] programParameters)
    {
        return Math.pow(left.evaluate(programParameters), 2) + Math.pow(right.evaluate(programParameters), 2);
    }
    ...
    public Node simplify()
    {
        ...
        {
            return new Circle(simplifiedLeft, simplifiedRight);
        }
        else
        {
            return this;
